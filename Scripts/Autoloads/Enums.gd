...
enum GameState {PLAYER_TURN, ENEMY_TURN, ROUND_END, SELECT_TARGET_UNIT, SELECT_TARGET_CELL, SHOP, REWARD}
...
enum Status {STUN, ROOT, POISON, BURN, INVISIBLE, SHIELD, FOREFIELD, HASTE, FROST}
...
enum SkillTarget {ANY_CELL, EMPTY_CELL, ENEMY_UNIT, HERO_UNIT, ANY_UNIT, LOS_UNIT,SELF}
