...
SELECT_TARGET_UNIT, SELECT_TARGET_CELL, SHOP, REWARD, TITLE, INVENTORY, FIND_GEAR}

enum Status {STUN, ROOT, POISON, BURN, INVISIBLE, SHIELD, FOREFIELD, HASTE, FROST, FREEZE, SPIKES, REGROW}
...
enum ItemType {UPGRADE, GEAR}

enum CellEffect {NONE,FIRE,WEB,POISON,TRAP,GRASS,SNOW}

enum SkillTarget {ANY_CELL, LOS_ANY_CELL, STRAIGHT_ANY_CELL, EMPTY_CELL, LOS_EMPTY_CELL, STRAIGHT_EMPTY_CELL, ENEMY_UNIT, LOS_ENEMY_UNIT, STRAIGHT_ENEMY_UNIT, ANY_UNIT, LOS_ANY_UNIT, STRAIGHT_ANY_UNIT, SELF, AUTO}

enum EnemyTarget {NONE, ATTACK_TARGET, ADJACENT_ENEMIES, RANDOM_ENEMY, NEAR_HERO}
